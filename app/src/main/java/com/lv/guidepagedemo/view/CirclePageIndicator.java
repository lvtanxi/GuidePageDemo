...
public class CirclePageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        int changeColor=a.getResourceId(R.styleable.CirclePageIndicator_changeColors,0);
        ...
        if(changeColor!=0){
            ...
            mChangeColors= getResources().getIntArray(changeColor);
        }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if(mArgbEvaluator!=null){
            ...
            mViewPager.setBackgroundColor((Integer) mArgbEvaluator.evaluate(positionOffset, getArgbEvaluatorColor(position), getArgbEvaluatorColor(nextPosition)));
        }
        if (mListener != null) {
    ...
    private int getArgbEvaluatorColor(int position) {
        if(mChangeColors.length>position)
            return mChangeColors[position];
